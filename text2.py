...
app=tkinter.Tk( )
app. overrideredirect (True)#将其标记设置为True
app. attributes('-alpha', 0.7)#填充颜色的深度
app. attributes('-topmost', 1)#置顶
app. geometry('200x100+100+100')#可视化窗口的设置
app.config(background="red")#设置背景为红色
labelDateTime=tkinter. Label( app, width=150)
labelDateTime. pack(fill=tkinter . BOTH, expand=tkinter. YES)
labelDateTime. configure(bg='blue')
